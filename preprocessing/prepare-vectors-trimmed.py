...
etyma = pd.read_csv('etyma-trimmed.tsv',   delimiter="\t", engine='python')
...
np.save(Path(__file__).parent.parent / "data" / "S_DUT_etymamatrix_trimmed.npy", S_DUT_matrix)
np.save(Path(__file__).parent.parent / "data" / "S_ENG_etymamatrix_trimmed.npy", S_ENG_matrix)
np.save(Path(__file__).parent.parent / "data" / "S_GER_etymamatrix_trimmed.npy", S_GER_matrix)
...
etyma_germandata.to_csv(
        Path(__file__).parent.parent / "data" / 'etyma_germandata_trimmed.tsv', sep='\t', index=False)

etyma_englishdata = merged_etyma_english[['Headword', 'English_IPA', 'English_Sound_Classes']]
etyma_englishdata.to_csv(
        Path(__file__).parent.parent / "data" / 'etyma_englishdata_trimmed.tsv', sep='\t', index=False)

etyma_dutchdata = merged_etyma_dutch[['Headword', 'Dutch_IPA', 'Dutch_Sound_Classes']]
etyma_dutchdata.to_csv(
        Path(__file__).parent.parent / "data" / 'etyma_dutchdata_trimmed.tsv', sep='\t', index=False)
