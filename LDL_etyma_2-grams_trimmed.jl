...
S_DUT = npzread(joinpath(@__DIR__, "data", "S_DUT_etymamatrix_trimmed.npy"))
S_ENG = npzread(joinpath(@__DIR__, "data", "S_ENG_etymamatrix_trimmed.npy"))
S_GER = npzread(joinpath(@__DIR__, "data", "S_GER_etymamatrix_trimmed.npy"))

# read in Datasets that were processed in Python
etyma_DUT = DataFrame!(CSV.File(joinpath(@__DIR__, "data", "etyma_dutchdata_trimmed.tsv"), delim="	"));
etyma_GER = DataFrame!(CSV.File(joinpath(@__DIR__, "data", "etyma_germandata_trimmed.tsv"), delim="	"));
etyma_ENG = DataFrame!(CSV.File(joinpath(@__DIR__, "data", "etyma_englishdata_trimmed.tsv"), delim="	"));
